...
data_ip="https://raw.githubusercontent.com/deyank00/deyankvps/main/ip"
checking_sc() {
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/deyank00/deyankvps/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/deyank00/deyankvps/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/deyank00/deyankvps/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/deyank00/deyankvps/main/"
...
#install cf
wget ${REPO}cobek/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/deyank00/deyankvps/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/deyank00/deyankvps/main/ip | grep $ipsaya | awk '{print $3}')
...
wget -O https://raw.githubusercontent.com/deyank00/deyankvps/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
function menu(){
    ...
    wget -q https://raw.githubusercontent.com/deyank00/deyankvps/main/kikitolan/mukung/menu.zip
    unzip menu.zip
    chmod +x menu/*
